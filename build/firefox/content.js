...
function CO2okTopBarButton(url)
{
  ...
  let co2logo = browser.extension.getURL('assets/img/logo.svg');
  let co2logowhite = browser.extension.getURL('assets/img/logo_wit.svg');
  ...
  let confirmButt = `
    ...
    <div class="logoButtCont">
      ...
      <a href=https://CO2ok.Ninja id="CO2okTopBarLogoLink">
          <img src="${browser.extension.getURL('assets/img/icon.png')}" id=CO2okTopBarLogo>
      </a>
      ...
      <div id=CO2okTopBarCTA>
        ...
        >
          ...
          <div class="shopText">${browser.i18n.getMessage('topbarActivateButton')}</div>
          <img src='${co2logo}' alt=''>

        </a>

        <div class="topbarActivatedInfo">${browser.i18n.getMessage('topbarActivateInfo')}</div>

      </div>

    </div>

    <img src=${browser.extension.getURL('assets/img/cancel.png')} id=CO2okTopBarIcon>
