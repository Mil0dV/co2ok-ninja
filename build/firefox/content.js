...
function CO2okTopBarButton(url)
{
  ...
  <!--  <div class="logoButtCont">-->
      ...
      <div id=CO2okTopBarCTA>
        ...
        <a href='http://co2ok.ninja/dojo/${url}?url=${location.href}&lang=${browser.i18n.getUILanguage()}' class='confirmButt' id="AltruistoTopBarButton" style='text-decoration: none;'
        ...
        <p class="topbarActivatedInfo" id="Co2okSmallText">${browser.i18n.getMessage('topbarActivateInfo')}</p>
