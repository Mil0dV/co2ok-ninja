...
function getContent(activated){
    ...
    let topbarActivatedInfo = `<p class="topbarActivatedInfo">${browser.i18n.getMessage('topbarActivateInfo')}</p>`;
...
// module
exports.push([module.i, "#CO2okTopBarButton,#CO2okTopBarButtonGrey,#CO2okTopBarCTA{display:inline-block;text-align:center;font-family:Helvetica,Arial,Verdana,sans-serif!important}#CO2okTopBar{width:350px!important;height:auto;border:1px solid #e0e0e0;border-radius:5px;background-color:#fff!important;box-shadow:2px 2px 20px 2px rgba(0,0,0,.3);position:fixed;top:35px;right:35px;z-index:100000000000000000;box-sizing:border-box;font-family:Helvetica,Arial,Verdana,sans-serif!important;text-align:center!important;line-height:1.4285;font-size:14px;color:#959595!important;animation:CO2ok-slide-in-right .5s cubic-bezier(.25,.46,.45,.94) 0s 1 normal both;display:flex;flex-direction:row;justify-content:flex-start;align-items:flex-start}#CO2okTopBarLogoLink{margin-top:15px}#CO2okTopBarLogo{max-width:100px!important;height:100px;margin:9px;position:relative;bottom:11px}#CO2okTopBarIcon{margin:10px;cursor:pointer;max-width:10px!important}#CO2okTopBarWelcome{font-size:12px;width:30%;float:left;margin:9px 0 0}#CO2okTopBarCTA{font-weight:700;margin:7px 0;width:80%;height:100px;margin-top:20px;display:flex;flex-direction:column-reverse;justify-content:center;align-items:center}#CO2okTopBarButton,#CO2okTopBarCTA{font-family:Helvetica,Arial,Verdana,sans-serif!important}#CO2okTopBarButton{border:1px solid #4caf50;background:#4caf50;color:#fff;border-radius:40px;padding:6px 12px;text-decoration:none;font-weight:700!important;line-height:1.4285;text-transform:uppercase;font-size:14px!important;margin-bottom:10px;padding:10px}#CO2okTopBarButton:hover{transform:scale(1.1);background-color:#439a46;color:#fff}.confirmButt{border:1px solid #4caf50;background:#fff;border-radius:12px;padding:6px 12px;margin-bottom:5px;padding:10px;display:flex;flex-direction:row;justify-content:center;align-items:center;width:80%;height:23px;text-decoration:none;margin-top:-3px}.topbarActivatedInfo{text-align:left;font-size:14px;width:90%;text-align:center}.confirmButt:hover{background:linear-gradient(#1defac 10.09%,#11d071 51.05%,#10cc6b 56.81%,#05b139)}.confirmButt:hover img{transition:transform .2s linear 0s;transform:scale(1.1)}.shopText{width:auto;height:auto;display:flex;flex-direction:row;justify-content:center;align-items:center}.confirmButt p{color:#0cbb4f;font-weight:700!important;line-height:1.4285;font-family:Helvetica,Arial,Verdana,sans-serif!important;font-size:27px!important;text-align:center;margin-right:7px;text-decoration:none;position:relative;bottom:1px}.confirmButt:hover p{color:#fff}.confirmButt img{width:80px;height:30px;position:relative;top:2px}#CO2okSmallText{font-weight:300px;font-size:12px;text-align:left;color:red}.thanksBar{width:auto;height:150px;display:flex;flex-direction:column;justify-content:center;align-items:center}.thanksBar img{width:50px;height:50px}thanksBar video{position:relative;bottom:3px}.thanksBar p{text-align:center;width:130%;font-size:13px;color:gray;margin:0;position:relative;bottom:1px;margin-top:5px;margin-bottom:-8px;right:42px}@-webkit-keyframes CO2ok-slide-in-right{0%{-webkit-transform:translateX(1000px);transform:translateX(1000px);opacity:0}to{-webkit-transform:translateX(0);transform:translateX(0);opacity:1}}@keyframes CO2ok-slide-in-right{0%{-webkit-transform:translateX(1000px);transform:translateX(1000px);opacity:0}to{-webkit-transform:translateX(0);transform:translateX(0);opacity:1}}", ""]);
